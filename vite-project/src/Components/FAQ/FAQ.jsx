...
<Accordion.Body style={{ backgroundColor: 'black', color: 'var(--secondary-color)' }}>
...
<Accordion.Item eventKey="4">
  ...
  <Accordion.Body style={{ backgroundColor: 'black', color: 'var(--secondary-color)' }}>Website owners should consider factors like the tailor’s experience, areas of expertise (e.g., alterations, custom designs, embroidery), reviews from other businesses, pricing, and location. It's also helpful to view the tailor’s portfolio for previous work.
  </Accordion.Body>
</Accordion.Item>
...
<Accordion.Item eventKey="5" className='my-4'>
  ...
  <Accordion.Body style={{ backgroundColor: 'black', color: 'var(--secondary-color)' }}>Website owners can review ratings, testimonials, and portfolios to assess the tailor’s expertise. They can also start with smaller projects to evaluate the tailor’s quality before committing to large orders.
  </Accordion.Body>
</Accordion.Item>

<Accordion.Item eventKey="6">
  <Accordion.Header>7. Are there any fees for website owners to connect with tailors?</Accordion.Header>
  <Accordion.Body  style={{ backgroundColor: 'black', color: 'var(--secondary-color)' }}>The platform may charge a subscription fee or a small commission for each successful match or transaction. Detailed pricing structures will be available when you sign up.
  </Accordion.Body>
</Accordion.Item>
